...
//https://leirbag.tistory.com/15
   ...
   public class Round_JLabel extends JButton {
	   Color back;
	   Color text;
      ...
      public Round_JLabel() { super(); decorate(); } 
      public Round_JLabel(String text) { super(text); decorate(); } 
      public Round_JLabel(Action action) { super(action); decorate(); } 
      public Round_JLabel(Icon icon) { super(icon); decorate(); } 
      public Round_JLabel(String text, Icon icon) { super(text, icon); decorate(); } 
